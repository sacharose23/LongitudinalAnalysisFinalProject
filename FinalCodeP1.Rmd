...
mean1 <- ggplot(bc, aes(x=month, y=bcarot, fill= dose)) +
  geom_point(pch=1) + 
  geom_smooth() + 
...
# w/o patient 57
mean2 <- ggplot(bc %>% filter(ptid != 57), aes(x=month, y=bcarot, fill= dose)) +
  geom_point(pch=1) + 
  geom_smooth() + 
...
ggsave("meanplots.png", arrangeGrob(mean1, mean2, mean3))
