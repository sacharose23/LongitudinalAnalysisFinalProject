...
ggsave("covplots.png", arrangeGrob(p.male, p.chol, p.bmi, p.age))
...
colnames(table) <- c("Male Est.", "Male Robust SE", "Chol. Est.", "Chol. Robust SE", "BMI Est.", "BMI Robust SE", "Age Est.", "Age Robust SE")
...
colnames(table2) <- c("Chol.(Cat) Est.", "Chol.(Cat) Robust SE", "BMI (Cat) Est.", "BMI (Cat) Robust SE", "Age (Cat) Est.", "Age (Cat) Robust SE")
...
table <- cbind(out1[,1],out2[,1],out1[,2],out2[,2])
